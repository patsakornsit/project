...
csv_file_path = "C:\\Users\\Acer\\Downloads\\for (1).csv"
Displayed_file_Path = "C:\\Users\\Acer\\Downloads\\displayed_data (1).csv"
...
response = response = "<beginner> B1 Python for Data Science, AI & Development B2 Computer Science: Programming with a Purpose free B3 Introduction to Computer Science and Programming specialization B4 IBM DevOps and Software Engineering <intermediate> I1 Java Programming and Software Engineering Fundamentals specialization I2 C Programming with Linux specialization I3 Applied Software Engineering Fundamentals specialization I4 Data Engineering Foundations specialization <advance> A1 Build a Modern Computer from First Principles: From Nand to Tetris (Project-Centered Course) A2 Machine Learning Engineering for Production (MLOps) specialization A3 Computer Vision for Engineering and Science specialization A4 IBM AI Engineering"
...
def receive_data():
    try:
        ...
        # Process the received data as needed (e.g., perform computations, save to database, etc.)
        print("Received data:", data)
        
        # Example: Accessing specific values from the received data
        if 'key' in data:
            print("Value of 'key':", data['key'])

        # Respond with a message indicating successful receipt of data
        return jsonify({'message': 'Data received successfully'})
    
    except Exception as e:
       return jsonify({'error': str(e)})  # Handling exceptions and returning error messages

@app.route('/for', methods=['GET'])
def get_variable():
    df = Value_DataFrame  # Assuming Value_DataFrame is defined and accessible here
